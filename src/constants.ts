...
// Proxies
export const proxiesContractNames = [
  "CurrencyConverterProxy",
  "LiquidatorProxy",
  "SoloBridgeProxy",
  "WethProxy",
];
...
// Test Contracts
export const testContractNames = [
  "Test_ExchangeWrapper",
  "Test_Lib",
  "Test_Funder",
  "Test_Monolith",
  "Test_Oracle",
...
export const baseProtocol = [
  { name: "PerpetualV1", args: [] },
  {
    name: "PerpetualProxy",
    args: [
      { type: "contract", value: "PerpetualV1" },
      { type: "account", value: "deployer" },
      { type: "_", value: "0x" },
    ],
  },
  ...
  { name: "TradeInfo", args: [{ type: "contract", value: "PerpetualProxy" }] },
  {
    ...
    args: [
      {
        type: `env${ARGS_SEPERATOR}contract${ARGS_SEPERATOR}_`,
        value: `USDC_ADDRESS_${ARGS_SEPERATOR}Test_Token${ARGS_SEPERATOR}0x0000000000000000000000000000000000000000`,
        appendNetwork: true,
      },
    ],
  },
...
export const fundingOracles = [
  {
    ...
    args: [
      {
        type: `env${ARGS_SEPERATOR}_`,
        value: `FUNDING_RATE_PROVIDER_ADDRESS_${ARGS_SEPERATOR}0x0000000000000000000000000000000000000000`,
        appendNetwork: true,
      },
    ],
  },
  {
    name: "InverseFundingOracle",
    args: [
      {
        type: `env${ARGS_SEPERATOR}_`,
        value: `FUNDING_RATE_PROVIDER_ADDRESS_${ARGS_SEPERATOR}0x0000000000000000000000000000000000000000`,
...
export const priceOracles = [
  {
    ...
    args: [
      {
        type: `env${ARGS_SEPERATOR}contract${ARGS_SEPERATOR}_`,
        value: `CHAIN_LINK_PRICE_ORACLE_ADDRESS_${ARGS_SEPERATOR}Test_ChainlinkAggregator${ARGS_SEPERATOR}0x0000000000000000000000000000000000000000`,
        appendNetwork: true,
      },
      { type: "contract", value: "PerpetualProxy" },
      {
        type: `env${ARGS_SEPERATOR}_`,
        value: `CHAIN_LINK_ORACLE_ADJUSTMENT_EXPONENT_${ARGS_SEPERATOR}28`,
        appendNetwork: true,
      },
    ],
  },
  { name: "MakerOracle", args: [] },
  {
    ...
    args: [
      ...
      {
        type: `env${ARGS_SEPERATOR}_`,
        value: `CHAIN_LINK_INVERSE_ORACLE_ADJUSTMENT_EXPONENT_${ARGS_SEPERATOR}16`,
        appendNetwork: true,
      },
    ],
  },
  {
    name: "MirrorOracleETHUSD",
    args: [
      {
        type: `env${ARGS_SEPERATOR}contract`,
        value: `MAKER_PRICE_ORACLE_ADDRESS_${ARGS_SEPERATOR}Test_MakerOracle`,
        appendNetwork: true,
      },
    ],
  },
...
export const traders = [
  {
    ...
    args: [
      { type: "contract", value: "PerpetualProxy" },
      { type: "globals", value: "networkChainId" },
    ],
  },
  {
    name: "InverseOrders",
  ...
  },
  {
    ...
    args: [
      ...
      {
        type: `env${ARGS_SEPERATOR}_`,
        value: `DELEVERAGING_OPERATOR_ADDRESS_${ARGS_SEPERATOR}0x0000000000000000000000000000000000000000`,
        appendNetwork: true,
      },
    ],
  },
  {
    name: "Liquidation",
    args: [{ type: "contract", value: "PerpetualProxy" }],
  },
] as ContractMeta[];
...
export const proxies = [
  { name: "CurrencyConverterProxy", args: [] },
  {
    ...
    args: [
      ...
      {
        type: `env${ARGS_SEPERATOR}_`,
        value: `INSURANCE_FUND_ADDRESS_${ARGS_SEPERATOR}0x0000000000000000000000000000000000000000`,
        appendNetwork: true,
      },
      {
        type: `env${ARGS_SEPERATOR}_`,
        value: `INSURANCE_FEE_${ARGS_SEPERATOR}100000000000000000`,
        appendNetwork: true,
      },
    ],
  },
  {
    name: "SoloBridgeProxy",
    args: [
      {
        type: `env${ARGS_SEPERATOR}contract`,
        value: `SOLO_ADDRESS_${ARGS_SEPERATOR}Test_Solo`,
        appendNetwork: true,
      },
      { type: "globals", value: "networkChainId" },
    ],
  },
  {
    ...
    args: [
      {
        type: `env${ARGS_SEPERATOR}contract`,
        value: `WETH_ADDRESS_${ARGS_SEPERATOR}WETH9`,
        appendNetwork: true,
      },
    ],
  },
